...
const CelanworksmithObjectActionTypes = {
  CELANWORKSMITH_LOAD_RETRY: "CELANWORKSMITH_LOAD_RETRY",
  CELANWORKSMITH_RUNTIME_CACHE_CLEAR_REQUEST:
    "CELANWORKSMITH_RUNTIME_CACHE_CLEAR_REQUEST",
  CELANWORKSMITH_RUNTIME_CACHE_CLEARED: "CELANWORKSMITH_RUNTIME_CACHE_CLEARED",
  CELANWORKSMITH_OBJECTS_LOAD_INIT: "CELANWORKSMITH_OBJECTS_LOAD_INIT",
  CELANWORKSMITH_OBJECT_TYPES_REFRESH_REQUESTED:
    "CELANWORKSMITH_OBJECT_TYPES_REFRESH_REQUESTED",
  CELANWORKSMITH_OBJECTS_METADATA_SUCCESS:
    "CELANWORKSMITH_OBJECTS_METADATA_SUCCESS",
  CELANWORKSMITH_OBJECT_TYPE_LOAD_START:
    "CELANWORKSMITH_OBJECT_TYPE_LOAD_START",
  CELANWORKSMITH_OBJECT_TYPE_REFRESH_START:
    "CELANWORKSMITH_OBJECT_TYPE_REFRESH_START",
  CELANWORKSMITH_OBJECT_TYPE_LOAD_SUCCESS:
    "CELANWORKSMITH_OBJECT_TYPE_LOAD_SUCCESS",
  CELANWORKSMITH_OBJECT_TYPE_LOAD_ERROR:
    "CELANWORKSMITH_OBJECT_TYPE_LOAD_ERROR",
  CELANWORKSMITH_OBJECT_TYPES_REFRESH_COMPLETE:
    "CELANWORKSMITH_OBJECT_TYPES_REFRESH_COMPLETE",
  CELANWORKSMITH_OBJECTS_LOAD_ERROR: "CELANWORKSMITH_OBJECTS_LOAD_ERROR",
  CELANWORKSMITH_OBJECTS_LOAD_REQUEST: "CELANWORKSMITH_OBJECTS_LOAD_REQUEST",
  CELANWORKSMITH_OBJECT_QUERY_REQUESTED:
    "CELANWORKSMITH_OBJECT_QUERY_REQUESTED",
  CELANWORKSMITH_OBJECT_QUERY_START: "CELANWORKSMITH_OBJECT_QUERY_START",
  CELANWORKSMITH_OBJECT_QUERY_SUCCESS: "CELANWORKSMITH_OBJECT_QUERY_SUCCESS",
  CELANWORKSMITH_OBJECT_QUERY_ERROR: "CELANWORKSMITH_OBJECT_QUERY_ERROR",
};

const CelanworksmithLinkActionTypes = {
  CELANWORKSMITH_LINK_METADATA_LOAD_REQUESTED:
    "CELANWORKSMITH_LINK_METADATA_LOAD_REQUESTED",
  CELANWORKSMITH_LINK_METADATA_LOAD_SUCCESS:
    "CELANWORKSMITH_LINK_METADATA_LOAD_SUCCESS",
  CELANWORKSMITH_LINK_METADATA_LOAD_ERROR:
    "CELANWORKSMITH_LINK_METADATA_LOAD_ERROR",
  CELANWORKSMITH_LINK_LOAD_REQUESTED: "CELANWORKSMITH_LINK_LOAD_REQUESTED",
  CELANWORKSMITH_LINK_LOAD_START: "CELANWORKSMITH_LINK_LOAD_START",
  CELANWORKSMITH_LINK_LOAD_SUCCESS: "CELANWORKSMITH_LINK_LOAD_SUCCESS",
  CELANWORKSMITH_LINK_LOAD_ERROR: "CELANWORKSMITH_LINK_LOAD_ERROR",
};

const CelanworksmithOntologyActionTypes = {
  CELANWORKSMITH_ONTOLOGY_LOAD_REQUEST: "CELANWORKSMITH_ONTOLOGY_LOAD_REQUEST",
  CELANWORKSMITH_ONTOLOGY_LOAD_SUCCESS: "CELANWORKSMITH_ONTOLOGY_LOAD_SUCCESS",
  CELANWORKSMITH_ONTOLOGY_LOAD_ERROR: "CELANWORKSMITH_ONTOLOGY_LOAD_ERROR",
};

const CelanworksmithApplicationBindingActionTypes = {
  CELANWORKSMITH_APPLICATION_BINDING_LOAD_REQUEST:
    "CELANWORKSMITH_APPLICATION_BINDING_LOAD_REQUEST",
  CELANWORKSMITH_APPLICATION_BINDING_LOAD_SUCCESS:
    "CELANWORKSMITH_APPLICATION_BINDING_LOAD_SUCCESS",
  CELANWORKSMITH_APPLICATION_BINDING_LOAD_ERROR:
    "CELANWORKSMITH_APPLICATION_BINDING_LOAD_ERROR",
  CELANWORKSMITH_APPLICATION_BINDING_SAVE_REQUEST:
    "CELANWORKSMITH_APPLICATION_BINDING_SAVE_REQUEST",
  CELANWORKSMITH_APPLICATION_BINDING_SAVE_SUCCESS:
    "CELANWORKSMITH_APPLICATION_BINDING_SAVE_SUCCESS",
  CELANWORKSMITH_APPLICATION_BINDING_SAVE_ERROR:
    "CELANWORKSMITH_APPLICATION_BINDING_SAVE_ERROR",
};

const CelanworksmithExecutionActionTypes = {
  CELANWORKSMITH_INPUT_CHANGED: "CELANWORKSMITH_INPUT_CHANGED",
  CELANWORKSMITH_INPUT_COMMITTED: "CELANWORKSMITH_INPUT_COMMITTED",
  CELANWORKSMITH_INPUT_REFRESH_OBSERVED:
    "CELANWORKSMITH_INPUT_REFRESH_OBSERVED",
  CELANWORKSMITH_FUNCTION_RUN: "CELANWORKSMITH_FUNCTION_RUN",
  CELANWORKSMITH_FUNCTION_RETRY: "CELANWORKSMITH_FUNCTION_RETRY",
  CELANWORKSMITH_FUNCTION_CANCEL: "CELANWORKSMITH_FUNCTION_CANCEL",
  CELANWORKSMITH_FUNCTION_QUEUED: "CELANWORKSMITH_FUNCTION_QUEUED",
  CELANWORKSMITH_FUNCTION_RUNNING: "CELANWORKSMITH_FUNCTION_RUNNING",
  CELANWORKSMITH_FUNCTION_SUCCEEDED: "CELANWORKSMITH_FUNCTION_SUCCEEDED",
  CELANWORKSMITH_FUNCTION_FAILED: "CELANWORKSMITH_FUNCTION_FAILED",
  CELANWORKSMITH_ACTION_RUN: "CELANWORKSMITH_ACTION_RUN",
  CELANWORKSMITH_ACTION_RETRY: "CELANWORKSMITH_ACTION_RETRY",
  CELANWORKSMITH_ACTION_CANCEL: "CELANWORKSMITH_ACTION_CANCEL",
  CELANWORKSMITH_ACTION_QUEUED: "CELANWORKSMITH_ACTION_QUEUED",
  CELANWORKSMITH_ACTION_RUNNING: "CELANWORKSMITH_ACTION_RUNNING",
  CELANWORKSMITH_ACTION_RETRYING: "CELANWORKSMITH_ACTION_RETRYING",
  CELANWORKSMITH_ACTION_SUCCEEDED: "CELANWORKSMITH_ACTION_SUCCEEDED",
  CELANWORKSMITH_ACTION_FAILED: "CELANWORKSMITH_ACTION_FAILED",
};
...
const IDEActionTypes = {
  ...
  SET_SHOW_TAB_ORDER_OVERLAY: "SET_SHOW_TAB_ORDER_OVERLAY",
...
const WidgetCanvasActionTypes = {
  ...
  UPDATE_META_WIDGET_PROPERTY_INIT: "UPDATE_META_WIDGET_PROPERTY_INIT",
...
export const ReduxActionTypes = {
  ...
  ...CelanworksmithObjectActionTypes,
  ...CelanworksmithLinkActionTypes,
  ...CelanworksmithOntologyActionTypes,
  ...CelanworksmithApplicationBindingActionTypes,
  ...CelanworksmithExecutionActionTypes,
} as const;
