...
if [[ "$maven_version_output" != *"Java version: 17."* ]] && [[ "$maven_version_output" != *"Java version: 25."* ]]; then
  echo $'\n'"Maven is not using Java 17 or 25. Please install a supported Java version." >&2
  exit 1
fi
